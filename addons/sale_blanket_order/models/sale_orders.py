...
class SaleOrderLine(models.Model):
    ...
    # ----------------เอาออกเพราะให้มันไม่เด้งออก เพราะจะเปิดสินค้าใดก็ได้มา Start-----------------
    ...
    # ----------------เอาออกเพราะให้มันไม่เด้งออก เพราะจะเปิดสินค้าใดก็ได้มา END-----------------

    # ห้ามลบ เอาออกเพราะติดของ alternative
