...
class BlanketOrderWizard(models.TransientModel):
    ...
    def _prepare_so_vals(
        ...
        return {
            ...
            "port_of_loading": self.blanket_order_id.port_of_loading,
            "shipment_by_id": self.blanket_order_id.shipment_by_id.id,
            "project_name": self.blanket_order_id.project_name.id
        }
