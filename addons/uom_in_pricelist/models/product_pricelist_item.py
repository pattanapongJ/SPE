...
#
#    Copyright (C) 20234-TODAY Cybrosys Technologies(<https://www.cybrosys.com>)
...
class PricelistItem(models.Model):
    ...
    product_uom_id = fields.Many2one(
        ...
        domain="[('id', 'in', product_uom_ids_rel)]",
        help="Defines the product uom of the product")
    
    product_uom_ids_rel = fields.Many2many(
        'uom.uom',
        string='Product UOMs', compute="_compute_product_uom_ids")
