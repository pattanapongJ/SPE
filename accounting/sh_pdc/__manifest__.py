# Copyright (C) Softhealer Technologies.
{
 ...
 Manage Post Dated Cheque App, View Vendor Invoice PDC , List Of Customer PDC Payment, Track Client PDC Process, Register Vendor Post Dated Cheque Module, Print VendorPDC Report, Print Client PDC Report Odoo. (original V14.0.4)""",
    "version": "14.2.0.1",
    "depends": [
        "account",
        "l10n_th_tax_invoice"
