odoo.define("bs_internal_account_statement_report.ReportActionManager", function (require) {
    "use strict";
    ...
    ActionManager.include({
        ...
        _executeReportClientAction: function (action, options) {
            const MODULE_NAME = "bs_internal_account_statement_report";
            ...
            if (action.report_name.startsWith(`${MODULE_NAME}.`)) {
                ...
                return this.doAction(
                    "bs_internal_account_statement_report.client_action",
                    clientActionOptions
                );
            }
