odoo.define("withholding_tax_report_widget", function (require) {
    ...
    var withholdingTaxReportWidget = Widget.extend({
        events: {
            "click .o_withholding_tax_report_web_action": "boundLink",
            "click .o_withholding_tax_report_web_action_multi": "boundLinkmulti",
            "click .o_withholding_tax_report_web_action_monetary": "boundLinkMonetary",
