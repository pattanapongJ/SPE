...
# Part of BrowseInfo. See LICENSE file for full copyright and licensing details.
{
    ...
    "author": "BrowseInfo",
    "summary": "Apps apply manual currency rate on invoice manual currency rate on payment manual currency rate on sales manual currency rate on purchase custom currency rate on invoice custom Currency Exchange Rate on Invoice custom Currency Exchange Rate on sales order Original(V14.4.0.1)",
    "description": """
