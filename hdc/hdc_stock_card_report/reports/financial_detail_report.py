...
class FinancialDetailView(models.TransientModel):
    _name = "financial.detail.view"
...
class FinancialDetailReport(models.TransientModel):
    _name = "report.financial.detail.report"
    _description = "Financial Detail Report"
    ...
    results = fields.Many2many(
        comodel_name="financial.detail.view",
    ...
    def _compute_results(self):
        ...
        ReportLine = self.env["financial.detail.view"]
    ...
    def _get_html(self):
        ...
        if report:
            ...
            result["html"] = self.env.ref(
                "hdc_stock_card_report.report_financial_detail_report_html"
            )._render(rcontext)
        return result
