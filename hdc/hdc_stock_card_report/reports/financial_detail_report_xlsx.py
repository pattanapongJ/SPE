...
class FinancialDetailXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, partners):
        ...
        sheet.merge_range('J9:L10', 'รับเข้า', head_cell_format)
        ...
        sheet.merge_range('M9:O10', 'จ่ายออก', head_cell_format)
        ...
        sheet.merge_range('P9:R10', 'ยอดคงเหลือ', head_cell_format)
        sheet.write(10,15, 'จำนวน', head_sub_cell_format)
        sheet.write(10,16, 'ราคา-หน่วย', head_sub_cell_format)
        sheet.write(10,17, 'มูลค่า', head_sub_cell_format)
        ...
        for i, product_ids in enumerate(product_id):
            ...
            if stock_move_id:
                ...
                if first_product == False:
                    ...
                    sheet.write_row(row,9, data_list,data_cell_number_format)  
                    row += 1 
                    first_product == True    
                    internal_total_qty = 0
                    internal_total_price = 0
                ...
                data_list = [product_ids.default_code or "",
                                ...
                                "",
                                "",]
                data_list_2 = [qty_available or"",
                                "",
                                "",
                                ]
                
                sheet.write_row(row,0, data_list,data_bold_cell_format)  
                sheet.write_row(row,15, data_list_2,data_bold_cell_format_number)  
                first_product = False              
                ...
                for stock_move_ids in stock_move_id:
                    ...
                    if location_ids:
                        ...
                        if warehouse_ids.ids in stock_move_line_ids.location_id.warehouse_id.ids:
                            location_id_check = True
                        if warehouse_ids.ids in stock_move_line_ids.location_dest_id.warehouse_id.ids:
                            location_dest_id_check = True
                    else:
                        location_id_check = True
                        location_dest_id_check = True
        ...
        total_cost_price = False
        if amount_total:
            total_cost_price = product_ids.standard_price
        data_list = [
                    internal_total_qty or "-",
                    internal_unit_price or "-",
                    internal_total_price or "-",
        ...
        data_list = ["",
                    ...
                    grand_amount_unit_price or "-", 
                    grand_amount_price_total or "-", 
                    ]
                
        sheet.write_row(row,0, data_list,format_footerC_bold)  
        sheet.write(row,4, "GRAND TOTAL", grandtotal_cell_format)
