odoo.define('hdc_allowed_warehouse_location.ReplenishReport', function (require) {
"use strict";
...
const ReplenishReport = clientAction.extend({
    ...
    _renderWarehouseFilters: function () {
        return this._rpc({
            ...
            // const allowed_warehouse = res.allowed_warehouse;
            ...
            console.log("EEEEEEEEEEEEEEEEEEEe", warehouses)
            const $filters = $(qweb.render('warehouseFilter', {
                ...
                // allowedWarehouse: "allowed_warehouse",
            }));
            // Bind handlers.
