    ...
    def action_confirm(self):
        ...
        for lines in select_quotation_line:
            ...
            quotation_line.append((0, 0, {
                'name': line.name, 'price_unit': lines.price_unit, 'tax_id': line.tax_id.mapped('id'),
                ...
                'product_no_variant_attribute_value_ids': line.product_no_variant_attribute_value_ids.mapped('id'),
        ...
        quotation = {
            ...
            'user_employee_id': quotation_id.user_employee_id.id,
            'sale_spec_employee': quotation_id.sale_spec_employee.id,
            'sale_manager_employee_id': quotation_id.sale_manager_employee_id.id,
            'user_sale_agreement_employee': quotation_id.user_sale_agreement_employee.id,
            'department_id': quotation_id.department_id.id,
            'expire_date': quotation_id.expire_date,
            'outline_agreement': quotation_id.outline_agreement,
            'project_name': quotation_id.project_name.id if quotation_id.project_name else False,
            'tag_ids': quotation_id.tag_ids,
            'room': quotation_id.room,
            'incoterm_id': quotation_id.incoterm_id.id if quotation_id.incoterm_id else False,
            'days_delivery': quotation_id.days_delivery,
            }
