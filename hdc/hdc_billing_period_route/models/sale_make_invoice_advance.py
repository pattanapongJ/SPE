...
class SaleAdvancePaymentInv(models.TransientModel):
    ...
    def _create_invoice(self, order, so_line, amount):
        ...
        if order.billing_period_id.id or order.billing_route_id.id:
            res['billing_period_id'] = order.billing_period_id.id
            res['billing_route_id'] = order.billing_route_id.id
