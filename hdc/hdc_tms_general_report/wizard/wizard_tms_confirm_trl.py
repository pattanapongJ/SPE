...
class WizardTmsTrl(models.TransientModel):
    _name = "wizard.tms.trl"
    ...
    def print_pdf(self):
        ...
        return self.env.ref('hdc_tms_general_report.tms_report_trl_view').report_action(self, data=data)
