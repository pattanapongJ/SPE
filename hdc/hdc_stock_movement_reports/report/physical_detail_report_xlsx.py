        ...
        for i, product_ids in enumerate(product_id):
            ...
            if stock_move_id:
                ...
                if first_product == False:
                    ...
                    merge_row = 'G' + str(row + 1) + ':H' + str(row + 1)
                    sheet.merge_range(merge_row, internal_total_qty,data_cell_number_format)

                    merge_row1 = 'I' + str(row + 1) + ':J' + str(row + 1)
                    sheet.merge_range(merge_row1, transit_total_qty,data_cell_number_format)

                    merge_row2 = 'K' + str(row + 1) + ':L' + str(row + 1)
                    sheet.merge_range(merge_row2, amount_total,data_cell_number_format)
