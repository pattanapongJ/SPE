...
class ProductTemplate(models.Model):
    ...
    alternative_ids_m2m = fields.Many2many("product.product", string="Alternatives Products")
...
class ProductAlternative(models.Model):
    ...
    template_ids = fields.Many2many("product.template", string="Related Products")
