...
class WizardMRPMRInterTransferModifyLine(models.TransientModel):
    _name = 'wizard.mrp.mr.intertransfer.modify.line'
    _description = 'wizard mrp mr inter transfer modify line'

    wizard_mrp_to_int_modify_ids = fields.Many2one(
        comodel_name="wizard.mrp.mr.intertransfer.modify",
        string="mrp to inter transfer modify",
    )
...
class WizardMRPMRInterTransferModify(models.TransientModel):
    _name = 'wizard.mrp.mr.intertransfer.modify'
    _description = 'wizard mrp mr inter transfer modify'
    ...
    order_line_ids = fields.One2many(
        comodel_name="wizard.mrp.mr.intertransfer.modify.line",
        inverse_name='wizard_mrp_to_int_modify_ids',
        string="Order Line",
    )
