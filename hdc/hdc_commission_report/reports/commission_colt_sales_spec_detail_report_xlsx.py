...
class CommissionColtSalesSpecDetailXlsx(models.AbstractModel):
    _name = 'report.commission_colt_sales_spec_detail_report_xlsx'
    _description = 'report.commission_colt_sales_spec_detail_report_xlsx'
