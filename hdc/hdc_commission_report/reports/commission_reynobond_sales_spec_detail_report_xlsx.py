...
class CommissionReynobondSalesSpecDetailXlsx(models.AbstractModel):
    _name = 'report.commission_reynobond_sales_spec_detail_report_xlsx'
    _description = 'report.commission_reynobond_sales_spec_detail_report_xlsx'
        ...
        for item in payment_lines:
            ...
            if invoice_id_current != invoice_id_old:
                ...
                data_list_1_2 = [            
                            ...
                            '',
                            '',
                            item.invoice_id.user_id.employee_id.name or '',
                            item.note or '',
                            ]
