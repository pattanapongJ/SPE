...
class WizardAccountChangeTotal(models.TransientModel):
    _name = "wizard.account.change.total"
    _description = 'wizard account change total'

    order_id = fields.Many2one('account.move', string='Account Move')
